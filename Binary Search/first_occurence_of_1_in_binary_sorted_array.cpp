/*The only diff btw this and normal bs is that the array is infinite and we can't set the upper limit  for it initilally*/
/*This is first occurence+infinite aarray combined*/
#include <bits/stdc++.h>
